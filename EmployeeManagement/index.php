...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="#attendence">Attendence</a>
                    </li>
                    <li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <p class="intro-text">It's Nice To Meet You<br></p>
    ...
    <section id="about" class="container content-section text-center">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <h2>About Online Attendence</h2>
                <p>Online attendence system is an online system to keep the daily records of Attendence of the workers in our company.It is very reliable,user-friendly and robust.</p>
				<h3> To learn how to give attendence</h3>
				</br>
				<a href="#myModal3" data-toggle="modal"><h4>click here</h4></a>
				</br>
				<h4>To give attendence</h4>
				 <a href="#attendence" class="btn btn-circle page-scroll">
                            <i class="fa fa-angle-double-down animated"></i>
                        </a>
    ...
    <section id="attendence" class="content-section text-center">
        <div class="download-section">
            <div class="container">
			<div style="font-family: 'Taviraj', serif; font-size:40px;">
			Please give your attendence by login into your respective account.
			</div>
				<div class="row">
                 <div class="col-md-6"><button href="#myModal" data-toggle="modal" class="w3-btn w3-hover-green w3-border w3-border-green w3-round-xlarge">Employee</button></div>
                 <div class="col-md-6"><button  href="#myModal1" data-toggle="modal" class="w3-btn w3-hover-green w3-border w3-border-green w3-round-xlarge">Administrator</button></div>
                 </div>	
				<div style="font-family: 'Taviraj', serif; font-size:40px;">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If you are a new employer then register yourself.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
